...
namespace Document_Approval_Project_BE.Services
{
    ...
    {
        public async Task SendEmail(DocumentApproval document, ApprovalPerson person, string type, string url)
        {
            try
            {
                var message = new MimeMessage();
                message.From.Add(new MailboxAddress("System Center", "nmnhan2641999@gmail.com"));
                message.To.Add(new MailboxAddress(person.ApprovalPersonEmail, person.ApprovalPersonEmail));
                            ...
                            <tr>
                                <td bgcolor=""#ffffff""
                                    ...
                                    <table border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">
                                        <tbody>
                                            <tr>
                                                <td bgcolor=""#ffffff"" style=""padding-top:5px;padding-bottom:5px"">Dear, </td>
                                            </tr>
                                            <tr>
                                                <td style=""padding-bottom:5px"">New comment on your request <a
                                                        href=""#m_-7502411160828829170_m_-6625880887437377346_"">00004-eDOC-LMART-2024
                                                        - Test han nhan
                                                        nhan</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style=""padding-bottom:5px"">asasf </td>
                                            </tr>
                                            <tr>
                                                <td style=""padding-bottom:5px""><a
                                                        href=""https://tasken.io/avn/documentapproval/view/8654"" target=""_blank""
                                                        data-saferedirecturl=""https://www.google.com/url?q=https://tasken.io/avn/documentapproval/view/8654&amp;source=gmail&amp;ust=1715741914377000&amp;usg=AOvVaw2ybYcYPEwGQADkvEdpiHV-"">
                                                        Clickhere</a> to view detail.
                                                </td>
                                            </tr>
                                            <tr>
